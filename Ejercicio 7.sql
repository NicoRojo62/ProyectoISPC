-- se deben cambiar los elementos de la base de datos
...
-- ejercicio 7 
select sum(monto) total from historial where fecha < '2022-7-1'; -- ingresos percibidos hasta julio de 2022
select sum(monto) total from historial where fecha between '2022-7-1' and '2022-7-31'; -- ingresos percibidos solo en julio de 2022
